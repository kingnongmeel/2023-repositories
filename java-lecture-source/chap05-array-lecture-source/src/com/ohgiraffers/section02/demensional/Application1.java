...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 위에서 진행한 2,3번을 동시에 진행 할 수도 있다.
        * 앞부분의 정수는 주소를 관리하는 배열의 크기, 뒷 부분 정수는 각 인덱스에 할당하는 배열의 길이이다.
        * 관리하는 여러 개의 배열의 길이가 동일한 경우 한 번에 할당할 수 있다.
        * 하지만 여러 개의 배열의 길이가 각각 다른 경우에는 인덱스별로 따로 할당해주어야 한다.
        * */
        iarr2 = new int[3][5];

        /* 4. 각 배열의 인덱스에 차례로 접근해서 값 출력
        * 할당 후에 아무 값을 대입하지 않더라도 heap 영역에는 값이 없는 상태로 공간을 생성할 수 없기 때문에 기본 값이 담겨 있다. */
