...
public class Application {
    public static void main(String[] args) {
        ...
        *
        * 제너릭은 클래스나 메소드에서 사용할 내부 데이터 타입을 컴파일시에 지정한다.
        * 컴파일 시에 미리 타입 검사를 시행하면 객체의 타입 안정성을 높일 수 있으며(잘못 된 타입일 경우 컴파일 에러를 발생 시킴),
        * 반환 값에 대한 타입 변환 및 타입 검사에 들어가는 코드 생략이 가능해진다.(instanceof 비교 및 다운캐스팅 작성 불필요)
        * JDK 1.5 버전부터 추가 된 문법이다.
        * */
    }
}
