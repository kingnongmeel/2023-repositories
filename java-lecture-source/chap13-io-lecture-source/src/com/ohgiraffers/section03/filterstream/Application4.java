...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        MemberDTO[] outputMembers = {
                ...
                new MemberDTO("user03", "pass03", "이순신", "lee123@ohgiraffers.com", 22, '남', 1234.6)
        };
        ...
        /* DTO 클래스에 직렬화 처리를 하지 않았다면 실행 시 NotSerializableException이 발생한다.
        * 직렬화란?
        * 자바 시스템 내부에서 사용 되는 객체 또는 데이터를 외부에서도 사용할 수 있도록 바이트(byte) 형태로 데이터를 변환하는 기술
        * 을 말한다. 반대로 바이트로 변환 된 데이터를 다시 객체로 변환하는 기술을 역직렬화라고 한다.
        * */
